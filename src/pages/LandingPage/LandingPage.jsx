      ...
      <div className="container-form">
        ...
        <div className="cards-container">
          {Now_playing.map((movie)=>(
              <Card id={movie.id} title={movie.title} language={movie.original_language} popularity={movie.popularity} genres={movie.genres} poster={movie.poster_path} released={true} date={movie.release_date}/>
          ))}
        </div>
      </section>
